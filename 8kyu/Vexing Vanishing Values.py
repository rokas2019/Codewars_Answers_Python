...
# even though you can clearly see, that the list should have the right values in it! Somehow, the values are simply
# disappearing! Is this a bug in the programming language itself...?
